      ...
      <div className="h-full pt-24 px-10 rounded-sm">
        ...
        <div className="h-[30rem] w-full mt-6 bg-[#fdfdfd] shadow-sm py-6 px-4">
          ...
          >
            ...
            <input
              className="border border-gray1 text-xl rounded-sm px-2 py-4 mb-4 outline-none focus:outline-blue1 focus:border-none"
              type="text"
              placeholder="Expense"
              ref={descriptionRef}
              required
            ...
            <select
              ...
              id="countries"
              ref={budgetIdRef}
              className="bg-gray2 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue1 focus:border-blue1 block w-full p-4 text-white"
            >
              {budgets?.map((budget) => (
            ...
            <button
              type="submit"
              className="w-full bg-blue2 text-white font-semibold py-4 mt-4 rounded-sm shadow-[5px_5px_10px_#415EDE] md:hover:scale-[1.015] md:transition-transform"
            >
              Add Bill
            </button>
          </form>
      ...
      <div className="h-full pt-12 px-10 rounded-sm">
        ...
        <div className="h-[23rem] w-full mt-6 bg-[#fdfdfd] shadow-sm py-6 px-4">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-blue1 text-white font-semibold py-4 rounded-sm shadow-[5px_5px_10px_#415EDE] md:hover:scale-[1.015] md:transition-transform"
            >
              Add Budget
            </button>
          </form>
