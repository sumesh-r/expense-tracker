    ...
    <section className="bg-split-gray-white min-h-screen pb-24 md:pb-36">
      ...
      {expensesTotal === 0 ? (
        <div className="mt-24 md:mt-32 px-10">
          <h1 className="text-3xl text-gray4 md:text-[3rem]">
            You havn't added any bill.
          </h1>
        </div>
      ) : (
        <div className="mt-24 md:mt-32 px-10">
          ...
          <div className="flex flex-col md:flex-row ">
            ...
            <div className="flex md:flex-col md:pt-20 justify-center mt-8 gap-8 md:gap-[30%] items-center bg-gray w-full h-[120px] md:h-[400px] md:mb-10 rounded-sm shadow-lg">
              <div className="flex flex-col items-center md:items-start gap-2 md:gap-1">
                <span className="text-gray3 font-semibold md:text-3xl">
                  Spent
                </span>
              ...
              <div className="flex flex-col items-center md:items-start gap-2 md:gap-1">
                <span className="text-gray3 md:text-3xl font-semibold">
                  Budget
                </span>
                <span className="text-3xl md:text-4xl text-gray4">
                  ₹{budgetTotal}
