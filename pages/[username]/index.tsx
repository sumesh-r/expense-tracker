...
const landingPage = () => {
  ...
  return (
    <section className="flex flex-col items-center bg-split-blue-gray min-h-screen h-fit min-w-full pb-32">
      ...
      <Link
        href="/addexpense"
        className="py-2 px-6 mt-4 w-[80%] text-center bg-blue2 text-white font-medium rounded-sm shadow-[5px_5px_10px_#0D26E0] md:hover:scale-105 md:transition-transform"
      >
        <button>Add +</button>
      </Link>
    </section>
